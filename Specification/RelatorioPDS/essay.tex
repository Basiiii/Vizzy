...
\begin{itemize}
    \item \textbf{Empréstimo/Aluguer e Venda}: Um produto pode estar disponível para empréstimo e venda simultaneamente, mas após a venda, ele é marcado como vendido.
    \item \textbf{Troca e Venda}: Um produto pode ser oferecido para troca ou venda, mas o utilizador deve escolher uma das opções.
    \item \textbf{Avaliações}: Todos os vendedores incluem avaliações pós-transação para garantir a qualidade e confiança na plataforma.
\end{itemize}

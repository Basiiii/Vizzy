...
// Custom metrics
const blockStatusTrend = new Trend('user_block_status_duration', true);
...
export const options = {
  ...
  thresholds: {
    ...
    user_block_status_duration: ['p(95)<400', 'p(99)<800'],
    errors: ['rate<0.01'],
  },
  setupTimeout: '30s',
};
...
/**
 * Tests the GET /users/block-status endpoint
 *
 * Test scenarios:
...
export default function (data) {
  ...
  check(res, {
    'Get Block Status: status is 200': (r) => r.status === 200,
    'Get Block Status: has isBlocked field': (r) =>

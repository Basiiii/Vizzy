...
// Custom metrics
const userLocationTrend = new Trend('user_location_duration', true);
...
export const options = {
  ...
  thresholds: {
    ...
    user_location_duration: ['p(95)<400', 'p(99)<800'],
    errors: ['rate<0.01'],
  },
  setupTimeout: '30s',
};
...
/**
 * Tests the GET /users/location endpoint
 *
 * Test scenarios:
...
export default function (data) {
  ...
  check(res, {
    'Get User Location: status is 200': (r) => r.status === 200,
    'Get User Location: has required fields': (r) =>
      r.json('id') !== undefined &&

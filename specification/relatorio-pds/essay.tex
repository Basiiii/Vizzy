...
{\Huge\textbf{Vizzy - Especificação}}\\[0.5cm] % Main Title
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|c|l|l|}
			...
			\hline
			\href{https://basigraphics.atlassian.net/browse/VIZZY-46}{\textbf{VIZZY-46}} & Utilizador Autenticado & Comprar/Alugar/Doar/Vender/Trocar um produto \\
			\hline
